...
class Encryption implements EncryptionInterface
{
	...
	* @return String
	*/
	public static function decrypt(string $data, int $sha2len = 32): string
	{
	...
	* @var String
	*/
	private static function _hash_equals($hmac, $_hash, $_decrypt)
	{
	...
	*/
	private static function _openssl_decrypt($data, $key, $iv)
	{
	...
	*/
	private static function _hash_hmac($crypt, $key, bool $binary=true)
	{
	...
	* @var String & openssl random pseudo bytes
	*/
	private static function _openssl_encrypt($data, $key, $iv) 
	{
	...
	* @var openssl random pseudo bytes
	*/
	private static function _iv($ivlen)
	{
